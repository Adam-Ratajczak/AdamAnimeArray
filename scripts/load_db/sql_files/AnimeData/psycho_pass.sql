...
INSERT INTO Songs(SongID, AnimeID, Title, Artist, Type, SpotifyUrl) VALUES (1066, 1502, '"abnormalize"', ' by Ling Tosite Sigure (凛として時雨)', 'js-theme-songs', 'https://open.spotify.com/track/00nmZvZRyzQiYe2tAcDDUb')INSERT INTO Songs(SongID, AnimeID, Title, Artist, Type, SpotifyUrl);
